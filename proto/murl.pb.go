...
func (x *URLShortenRequest) Reset() {
	*x = URLShortenRequest{}
	mi := &file_proto_murl_proto_msgTypes[0]
...
func (x *URLShortenResponse) Reset() {
	*x = URLShortenResponse{}
	mi := &file_proto_murl_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandRequest) Reset() {
	*x = URLExpandRequest{}
	mi := &file_proto_murl_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandResponse) Reset() {
	*x = URLExpandResponse{}
	mi := &file_proto_murl_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UserURLsResponse) Reset() {
	*x = UserURLsResponse{}
	mi := &file_proto_murl_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLData) Reset() {
	*x = URLData{}
	mi := &file_proto_murl_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_proto_murl_proto protoreflect.FileDescriptor

const file_proto_murl_proto_rawDesc = "" +
	"\n" +
	"\x10proto/murl.proto\x12\x05proto\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x17.proto.UserURLsResponseB\fZ\n" +
	"murl/protob\beditionsp\xe8\a"

var file_proto_murl_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_murl_proto_goTypes = []any{
...
var file_proto_murl_proto_depIdxs = []int32{
...
func init() { file_proto_murl_proto_init() }
func file_proto_murl_proto_init() {
	if File_proto_murl_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_murl_proto_rawDesc), len(file_proto_murl_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_murl_proto_goTypes,
		DependencyIndexes: file_proto_murl_proto_depIdxs,
		MessageInfos:      file_proto_murl_proto_msgTypes,
	}.Build()
	File_proto_murl_proto = out.File
	file_proto_murl_proto_goTypes = nil
	file_proto_murl_proto_depIdxs = nil
}
