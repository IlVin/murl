...
// Source: github.com/jackc/pgx/v5 (interfaces: Tx,Row,BatchResults)
//
// Generated by this command:
//
//	mockgen -destination=pg_batch_exec_pgx_mock_test.go -package=pgbatch github.com/jackc/pgx/v5 Tx,Row,BatchResults
//
