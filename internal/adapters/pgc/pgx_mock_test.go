...
// Source: github.com/jackc/pgx/v5 (interfaces: Tx,Row,BatchResults,Rows)
//
// Generated by this command:
//
//	mockgen -destination=pgx_mock_test.go -package=pgc github.com/jackc/pgx/v5 Tx,Row,BatchResults,Rows
//
